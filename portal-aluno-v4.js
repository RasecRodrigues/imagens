...
function carregarPartesPortalAluno() {
  ...
  /*
   * Primeiro carrega o resumo preparado, que é leve.
   * A mensalidade e os comprovantes são buscados separadamente.
   */
  google.script.run
    ...
    .withFailureHandler(e => {
      ...
      finalizarMensalidadeHomeSemDadosPortalAluno_(
        'Não foi possível carregar a mensalidade agora. Consulte Pagamentos ou fale com a Secretaria.'
      );

      console.error(e);
    })
    .obterDadosPortalAluno(sessao);
}
